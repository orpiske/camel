...
By default, DJL will download the TensorFlow native libraries into the https://docs.djl.ai/docs/development/cache_management.html[cache folder] the first time you run DJL.
It will automatically determine the appropriate jars for your system based on the platform and GPU support.
...
By default, DJL will download the Apache MXNet native libraries into the https://docs.djl.ai/docs/development/cache_management.html[cache folder] the first time you run DJL.
It will automatically determine the appropriate jars for your system based on the platform and GPU support.
