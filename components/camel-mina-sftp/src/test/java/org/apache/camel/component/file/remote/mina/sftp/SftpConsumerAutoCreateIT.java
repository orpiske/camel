...
public class SftpConsumerAutoCreateIT extends SftpServerTestSupport {
    protected String getFtpUrl() {
        return "mina-sftp://admin@localhost:{{ftp.server.port}}/{{ftp.root.dir}}/foo/bar/baz/xxx?password=admin&knownHostsFile="
    ...
    public void testAutoCreate() {
        MinaSftpEndpoint endpoint = (MinaSftpEndpoint) this.getMandatoryEndpoint(getFtpUrl() + "&autoCreate=true");
        endpoint.start();
